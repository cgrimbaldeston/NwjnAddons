export default class EntityUtil {
     ...
     */
    static removeEntity = (entity) => World.getWorld().func_72900_e(entity)
     ...
     * @returns {MCTEntity}
    */
    static removeEntityByID = (id) => World.getWorld().func_73028_b(id)

    /**
     * Used for removing if entity is known to not be a player entity
     */
    static setDead = (entity) => entity.func_70106_y()

    static getEntityByID = (id) => World.getWorld().func_73045_a(id)
     ...
     */
    static getMaxHP = (entity) => ~~entity.func_110140_aT().func_111152_a('generic.maxHealth').func_111125_b()
     ...
     */
    static getHP = (entity) => ~~entity.func_110143_aJ() // getHealth
